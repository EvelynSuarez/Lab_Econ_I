...
#
#
#Utilizamos una base de datos de Journals y hacemos gráficas
#Y generamos datos de manera aleatoria y hacemos otros tipos de gráficas.
# ----------------------------------
...
setwd("C://Users/Lupita Reyes/Documents")
...
#Podemos duardar las gráficas de dos maneras en formato png y jpg, donde ong hace transparencias
...
barplot(tab)
pie(tab)
#sortdtab ordena de mayor a menor los datos 
...
# 25 dices en que punto de x lo quieres y 13 en que punto de las y
